                            ...
                            <ul class="mobile-menu-nav">
                                <li><a data-toggle="collapse" data-target="#Charts" href="#">Inicio</a>
                                    <ul class="collapse dropdown-header-top">
                                        <li><a href="<?php echo e(url('welcome')); ?>.html">Inicio</a></li>
                                    </ul>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="contact-list">
                        ...
                        <a href="<?php echo e(url('expedientes_listado')); ?>"><button class="btn btn-success notika-btn-success">Expediente</button></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="contact-list sm-res-mg-t-30">
                        ...
                        <a href="<?php echo e(url('proyectos_listado')); ?>"><button class="btn btn-warning notika-btn-warning">Proyectos</button></a>
                    </div>
                </div>
